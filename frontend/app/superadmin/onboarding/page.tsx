    ...
    <>
      ...
      <div className="grid g-2-1">
        <div className="card reveal in" data-delay="1">
          ...
          {wizard.step === 4 ? (
            <StepComingSoon
              title="Step 4 · Templates & modules"
              blurb="Template and module assignment is being built separately. You can still activate the organisation now — templates can be granted later from the org's detail page."
              onBack={() => goTo(3)}
              onContinue={() => goTo(5)}
            />
          ) : null}
