...
export default function SuperAdminTemplatesPage() {
  ...
  const STAT_TILES = [
    { label: "Total templates", value: stats.total, ic: "ic-indigo", emoji: "🧩" },
    { label: "Predefined", value: stats.predefined, ic: "ic-violet", emoji: "📐" },
    { label: "Custom", value: stats.custom, ic: "ic-sky", emoji: "✨" },
    { label: "Published", value: stats.published, ic: "ic-green", emoji: "🚀" },
  ];
