...
const TOP_ORGS = [
  { name: "Dubai Prime Estates", city: "Dubai", leads: "2,180", plan: "b-violet", planTxt: "Agency" },
  { name: "Skyline Developers", city: "Ahmedabad", leads: "1,940", plan: "b-violet", planTxt: "Agency" },
  { name: "Marina Bay Realty", city: "Mumbai", leads: "1,610", plan: "b-indigo", planTxt: "Growth" },
  { name: "Green Acres Realty", city: "Pune", leads: "1,285", plan: "b-indigo", planTxt: "Growth" },
  { name: "Al Habtoor Homes", city: "Abu Dhabi", leads: "1,120", plan: "b-violet", planTxt: "Agency" },
  { name: "Urban Roots Housing", city: "Bengaluru", leads: "860", plan: "b-gray", planTxt: "Starter" },
];
