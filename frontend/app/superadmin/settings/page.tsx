...
const INTEGRATIONS = [
  { ic: "ic-indigo", emoji: "💳", name: "Razorpay", desc: "Collect template & subscription payments in INR.", badge: "b-green", badgeTxt: "Connected", on: true },
  { ic: "ic-green", emoji: "💬", name: "WhatsApp Business API", desc: "Lead alerts & buyer conversations for orgs.", badge: "b-green", badgeTxt: "Connected", on: true },
  { ic: "ic-sky", emoji: "📘", name: "Meta", desc: "Lead ads & pixel sync for property campaigns.", badge: "b-green", badgeTxt: "Connected", on: true },
  { ic: "ic-amber", emoji: "📊", name: "Google Ads / GTM", desc: "Tag manager & conversion tracking container.", badge: "b-gray", badgeTxt: "Not connected", on: false },
  { ic: "ic-violet", emoji: "✉️", name: "SMTP Email", desc: "Transactional email for invites & receipts.", badge: "b-green", badgeTxt: "Connected", on: true },
  { ic: "ic-rose", emoji: "📈", name: "Google Analytics", desc: "GA4 property traffic for org landing pages.", badge: "b-gray", badgeTxt: "Not connected", on: false },
];
  ...
  return (
    <>
      <div className="page-head reveal in">
        <div>
          <div className="eyebrow">⚙️ System</div>
