...
// Landing-page approval was removed — orgs publish their own pages directly
// now (approval is moving to domain verification instead, a separate,
// not-yet-designed piece). Organisation sign-up approval is untouched.
    ...
    <>
      <div className="page-head reveal in">
        <div>
          ...
          <h1>Approvals</h1>
          <div className="sub">Organisation sign-ups awaiting super admin review.</div>
        </div>
      </div>

      <OrganisationApprovalsTab accessToken={accessToken} />
    </>
  );
}
...
// unchanged (same endpoints, same behaviour). The team plans to retire this
// in favour of the inline Approve/Reject already on the Organisations list,
