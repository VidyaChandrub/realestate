...
export default function CreatePlanPage() {
  ...
  const [form, setForm] = useState({
    ...
    features: ["Core Module Access", "Standard Analytics", "Multi-user Roles", "Email Notifications"] as string[],
  });
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24, flexWrap: "wrap", gap: 16 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ fontSize: 12, color: "#64748b", fontWeight: 600, background: "#f1f5f9", padding: "6px 12px", borderRadius: 999 }}>
            API Endpoint: <code style={{ color: "#0f1424", fontWeight: 700 }}>/admin/plans</code>
          </div>
        </div>
      </div>
            ...
            <div style={{ background: "#fff", borderRadius: 16, padding: 24, border: "1px solid rgba(226, 232, 240, 0.8)", boxShadow: "0 2px 6px rgba(15, 23, 42, 0.03)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
                ...
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: 12, color: "#64748b" }}>Define tier name, slug, description, and monthly/yearly rates.</p>
                </div>
              </div>
          ...
          <div style={{ position: "sticky", top: 80 }}>
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                >
                  {saving ? "Creating Plan..." : "＋ Create & Publish Plan"}
                </button>
                <Link
                  href="/admin-console/subscriptions"
                  style={{
