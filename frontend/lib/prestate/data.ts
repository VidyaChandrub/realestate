...
export const WIDGETS: WidgetDef[] = [
  ...
  { id: "carousel", label: "Carousel", category: "Layout", group: "Layout", icon: Images, desc: "Auto-rotating slides", make: () => sec("carousel", "Carousel", "Images", { slides: [{ caption: "Skyline view", image: "" }, { caption: "Clubhouse", image: "" }, { caption: "Landscaped gardens", image: "" }], autoplay: true, interval: 5000 }) },
  { id: "slider", label: "Slider", category: "Layout", group: "Layout", icon: SlidersHorizontal, desc: "Content slider", make: () => sec("slider", "Slider", "SlidersHorizontal", { slides: [{ caption: "Slide one", image: "" }, { caption: "Slide two", image: "" }, { caption: "Slide three", image: "" }], autoplay: false, interval: 5000 }) },
  ...
  { id: "gallery", label: "Property Gallery", category: "Real Estate", group: "Real Estate", icon: Images, desc: "Image masonry", make: () => sec("gallery", "Property Gallery", "Images", { eyebrow: "Gallery", heading: "Project Gallery", text: "A look inside the development.", images: ["1", "2", "3", "4", "5", "6"], columns: 3, lightbox: true, captions: [] }) },
  ...
  { id: "brochure", label: "Brochure Download (Gated)", category: "Real Estate", group: "Real Estate", icon: FileText, desc: "Click → form popup → validation → download", make: () => sec("brochure", "Brochure Download", "FileText", { heading: "Download Brochure", title: "Download Brochure", file: "", text: "Get the full project kit — plans, specs and pricing.", gateEnabled: true, popupId: "", gateHeading: "Get the brochure in your inbox", gateText: "Share your details and the download starts instantly.", gateFields: [{ id: "g1", type: "text", label: "Full Name", placeholder: "Your name", required: true }, { id: "g2", type: "phone", label: "Phone Number", placeholder: "+91 98XXX XXXXX", required: true }, { id: "g3", type: "email", label: "Email Address", placeholder: "you@email.com", required: true }], gateButton: "Submit & Download", gateSuccessMessage: "Verified — your brochure is downloading." }) },
  { id: "downloads", label: "Downloads", category: "Real Estate", group: "Real Estate", icon: Download, desc: "Document downloads", make: () => sec("downloads", "Downloads", "Download", { heading: "Downloads", files: [{ name: "Brochure.pdf", url: "" }, { name: "Floor plans.pdf", url: "" }] }) },
  ...
  { id: "faq", label: "FAQ / Accordion", category: "Real Estate", group: "Real Estate", icon: PanelsTopLeft, desc: "Questions & answers", make: () => sec("faq", "FAQ", "Tabs", { eyebrow: "Help", heading: "Frequently asked questions", items: [{ q: "Is the project RERA registered?", a: "Yes — {{rera_number}}." }, { q: "When is possession?", a: "{{possession_date}}" }] }) },
  ...
  // FORMS
  { id: "lead-form", label: "Lead Form", category: "Forms", group: "Forms", icon: Send, desc: "Single-step form", make: () => sec("lead-form", "Lead Form", "Send", { heading: "Request a Callback", fields: ["name", "phone"], button: "Submit", pdfUrl: "", pdfLabel: "" }) },
  { id: "multistep-form", label: "Multi Step Form", category: "Forms", group: "Forms", icon: Table2, desc: "Step-by-step form", make: () => sec("multistep-form", "Multi Step Form", "Table2", { heading: "Book a Site Visit", steps: 3, button: "Book My Visit", pdfUrl: "", pdfLabel: "" }) },
  ...
  { id: "enquiry-form", label: "Enquiry Form", category: "Forms", group: "Forms", icon: Send, desc: "General enquiry form", make: () => sec("enquiry-form", "Enquiry Form", "Send", { heading: "Get Detailed Pricing", fields: ["name", "phone", "email"], button: "Submit Enquiry", pdfUrl: "", pdfLabel: "" }) },
  ...
  { id: "sticky-footer-bar", label: "Sticky Footer Bar", category: "Header & Footer", group: "Header & Footer", icon: PanelBottom, desc: "Bottom bar", make: () => sec("sticky-footer-bar", "Sticky Footer Bar", "PanelBottom", { text: "", ctaLabel: "Enquire Now", link: "#lead-form" }) },
