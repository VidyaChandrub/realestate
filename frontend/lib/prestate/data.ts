...
export const WIDGETS: WidgetDef[] = [
  ...
  { id: "popup-cta", label: "Popup CTA", category: "Marketing", group: "Marketing", icon: Gift, desc: "Triggered popup", make: () => sec("popup-cta", "Popup CTA", "Gift", { heading: "Limited Offer", text: "Lock founder pricing this month.", cta: "Claim Offer", link: "#lead-form", trigger: "delay", delaySeconds: 3, scrollPercent: 40 }) },
  ...
  { id: "popup", label: "Popup", category: "Marketing", group: "Marketing", icon: PartyPopper, desc: "Modal promotion", make: () => sec("popup", "Popup", "PartyPopper", { heading: "Get Brochure", text: "Share your details to download the kit.", cta: "Download", link: "#lead-form", trigger: "delay", delaySeconds: 3, scrollPercent: 40 }) },
