...
export const WIDGETS: WidgetDef[] = [
  ...
  { id: "location-advantages", label: "Location & Map", category: "Real Estate", group: "Real Estate", icon: Navigation, desc: "Embedded map plus connectivity points", make: () => sec("location-advantages", "Location & Map", "Navigation", { address: "Sarjapur Road, Bangalore", zoom: 14, eyebrow: "Connectivity", heading: "Location Advantages", text: "Minutes from work, school and transit.", items: [{ icon: "TrainFront", title: "Metro", meta: "5 min" }, { icon: "School", title: "Schools", meta: "2 km" }, { icon: "Hospital", title: "Hospital", meta: "3 km" }, { icon: "Store", title: "Mall", meta: "4 km" }] }) },
  ...
  { id: "faq", label: "FAQ / Accordion", category: "Real Estate", group: "Real Estate", icon: PanelsTopLeft, desc: "Collapsible questions & answers", make: () => sec("faq", "FAQ", "Tabs", { eyebrow: "Help", heading: "Frequently asked questions", items: [{ q: "Is the project RERA registered?", a: "Yes — {{rera_number}}." }, { q: "When is possession?", a: "{{possession_date}}" }] }) },
