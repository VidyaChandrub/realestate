...
export const WIDGETS: WidgetDef[] = [
  ...
  { id: "floorplans", label: "Floor Plans", category: "Real Estate", group: "Real Estate", icon: Grid, desc: "Plan selector", make: () => sec("floorplans", "Floor Plans", "Grid", { design: "cards", eyebrow: "Layouts", heading: "Floor Plans", text: "Choose a configuration.", plans: [{ name: "3 BHK", beds: "3", area: "1,650 sq.ft", price: "₹1.25 Cr" }, { name: "4 BHK", beds: "4", area: "2,450 sq.ft", price: "₹1.95 Cr" }] }) },
