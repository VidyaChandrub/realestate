...
export const blockMetadata: BlockMeta[] = [
  ...
  },
  {
    ...
    defaultProps: {
      ...
      links: ['Overview', 'Amenities', 'Plans', 'Gallery', 'Contact'],
    },
  },
  {
    type: 'project-banner',
  ...
  },
  {
    ...
    category: 'Real Estate',
    variants: ['grid', 'table', 'two-column', 'checklist'],
    defaultProps: { title: 'Property Details', items: [{ label: 'Type', value: 'Apartment' }, { label: 'Possession', value: 'Dec 2027' }], anchor: 'highlights' },
  },
  {
    type: 'gallery',
  ...
  },
  {
    type: 'floor-plans',
    label: 'Floor Plans',
    description: 'Gated gallery — Form Builder unlock + download',
    category: 'Real Estate',
    variants: ['cards', 'list', 'showcase'],
    defaultProps: {
      title: 'Floor Plans',
      gateEnabled: true,
      formId: '',
      items: [{ name: '2 BHK', beds: '2 Beds', area: '1,145 sq.ft', price: '', image: '', downloadUrl: '' }],
      anchor: 'plans',
    },
  },
  {
  ...
  },
  {
    ...
    category: 'Real Estate',
    variants: ['cards', 'simple', 'comparison', 'banner'],
    defaultProps: { title: 'Pricing', startingPrice: '₹ 1.42 Cr*', items: [{ name: '2 BHK', price: '₹ 1.42 Cr*', meta: '' }], anchor: 'pricing' },
  },
  {
    type: 'payment-plan',
    label: 'Payment Plan',
  ...
  },
  {
    ...
    description: 'About the developer with stats or logo band',
    category: 'Real Estate',
    variants: ['default', 'split', 'stats', 'band'],
    defaultProps: { title: 'About the Developer', name: '', body: '', image: '', logo: '', stats: [], anchor: 'builder' },
  },
  {
    type: 'team',
  ...
  },
  {
    ...
    category: 'Real Estate',
    variants: ['cards', 'carousel', 'spotlight', 'band'],
  ...
  },
  {
    ...
    category: 'Real Estate',
    variants: ['split', 'card', 'banner', 'minimal'],
    defaultProps: {
  ...
  },
  {
    ...
    category: 'Real Estate',
    variants: ['card', 'split', 'inline', 'default'],
    defaultProps: { title: 'Enquire now', subtitle: '', formId: '', image: '', anchor: 'enquire' },
  },
  {
    type: 'site-visit',
    label: 'Site Visit Booking',
    description: 'Book a site visit with Form Builder',
    category: 'Real Estate',
    variants: ['default'],
    defaultProps: { title: 'Book a site visit', subtitle: '', formId: '', anchor: 'site-visit' },
  },
  {
    type: 'contact',
    label: 'Contact Form',
    description: 'Contact section with Form Builder form',
    category: 'Real Estate',
    variants: ['default'],
    defaultProps: { title: 'Get in Touch', subtitle: '', formId: '', anchor: 'contact' },
  },
  {
    type: 'newsletter',
    label: 'Newsletter Signup',
    description: 'Email / updates capture via Form Builder',
    category: 'Real Estate',
    variants: ['default'],
    defaultProps: { title: 'Stay in the loop', subtitle: 'Get updates on this project. No spam.', formId: '', anchor: 'newsletter' },
  },
  {
    type: 'footer',
    label: 'Footer',
