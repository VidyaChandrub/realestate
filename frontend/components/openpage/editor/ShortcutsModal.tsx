...
const shortcutGroups = [
  {
    ...
    shortcuts: [
      ...
      { keys: ['2'], description: 'Style tab' },
      { keys: ['3'], description: 'Typography tab' },
      { keys: ['4'], description: 'Advanced tab' },
    ],
  },
  {
    title: 'Editor',
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ['\u2318', 'C'], description: 'Copy block style' },
      { keys: ['\u2318', 'V'], description: 'Paste block style' },
    ],
  },
  {
    title: 'History',
