            ...
            <div style={{ display: "flex", gap: 6, background: "#f8fafc", padding: 3, borderRadius: 10, border: "1px solid #e2e8f0" }}>
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  border: "none",
                  background: !selectedOrgId ? "#4f46e5" : "transparent",
                ...
                {PRESET_OPTIONS.map((opt) => (
                  <button
                    ...
                    style={{
                      ...
                      color: filter.preset === opt.id ? "#4f46e5" : "#334155",
                      background: filter.preset === opt.id ? "rgba(79, 70, 229, 0.08)" : "transparent",
                      border: "none",
                      cursor: "pointer",
                      textAlign: "left",
                    }}
                ...
                <tbody>
                  {agents.map((agt) => (
                    <tr key={agt.agentId} style={{ borderBottom: "1px solid #f8fafc" }}>
                      ...
                      <td style={{ padding: "10px 0", textAlign: "center", fontWeight: 700, color: "#4f46e5" }}>{agt.conversionRate}%</td>
