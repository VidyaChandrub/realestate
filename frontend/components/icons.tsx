...
const paths: Record<IconName, React.ReactNode> = {
  ...
  pin: (
    <path d="M12 17v5M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V17h14v-1.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V6h1a2 2 0 0 0 0-4H8a2 2 0 0 0 0 4h1z" />
  ),
  flame: (
  ...
  crown: (
    <>
      <path d="M3 18L5 7L9.5 12L12 4L14.5 12L19 7L21 18H3Z" />
      <path d="M3 19.5H21" />
    </>
  ),
  activity: (
