    ...
    : [
        {
          ...
          required: true,
        } as unknown as SiteConfig["form"]["fields"][number],
        {
          id: "f2",
          type: "phone",
          label: "Phone",
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (live && pageId) {
        ...
        const popupAfter = String(
          (effectiveForm as unknown as { openPopupId?: string })?.openPopupId ??
            "",
        ).trim();
    ...
    >
      <div
        style={{
          ...
          background: project.coverImageUrl
            ...
            : "linear-gradient(135deg, #eef0fe 0%, #ede9fe 100%)",
          position: "relative",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
      ...
      >
        {!project.coverImageUrl ? (
          <Building2 size={36} color="#6D5DFC" style={{ opacity: 0.4 }} />
        ) : null}
        <span
          style={{
            position: "absolute",
            top: 10,
            left: 10,
            background: project.status === "active" ? "#16a34a" : "#64748b",
            color: "#fff",
            fontSize: 10,
            fontWeight: 800,
            letterSpacing: 0.6,
      ...
      >
        ...
        {project.location || project.city ? (
          ...
          >
            <MapPin size={12} />{" "}
            {project.location ||
              `${project.locality ?? ""} ${project.city ?? ""}`.trim()}
          </div>
        ) : null}
        <div
          style={{
...
export function ProjectSection({
  ...
  const selectedProjectId =
    typeof st.selectedProjectId === "string" ? st.selectedProjectId : null;
        ...
        return [
          {
            ...
            visibleToTelecallers: true,
            publishedToWebsite: false,
            coverImageUrl: null,
            galleryUrls: [],
            brochureUrl: null,
            reraCertificateUrl: null,
    ...
    layout === "list"
      ...
      : layout === "carousel"
        ...
        : {
            display: "grid",
            gridTemplateColumns:
              device === "mobile" ? "1fr" : `repeat(${Math.min(cols, 3)},1fr)`,
            gap: 16,
          };
    ...
    return (
      ...
      >
        ...
        <div style={{ fontSize: 12.5, marginTop: 6 }}>
          {live
            ? "Projects will appear here once added to this organisation."
            : "Add projects in Organisation → Projects, then select one in this widget's Settings."}
        </div>
      </div>
    );
  }
      ...
      <div style={gridStyle}>
        {display.map((p) => (
          <div
            ...
            style={
              layout === "carousel"
                ? { minWidth: 300, scrollSnapAlign: "start", flexShrink: 0 }
                : undefined
            }
          >
            <ProjectCard
              project={p}
              onEnquire={() => setActive(p)}
              compact={layout === "list"}
            />
          </div>
        ))}
